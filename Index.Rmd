...
Download this Excel file and follow the steps, using the tab called "Exple1 - good" as the data sheet we want to save: [BasicExample.xlsx](https://github.com/stats4sd/r2020_04Importing/raw/main/BasicExample.xlsx)
...
To make it empty, simply click `Create Empty Document` at the bottom left of the window that pops up.
